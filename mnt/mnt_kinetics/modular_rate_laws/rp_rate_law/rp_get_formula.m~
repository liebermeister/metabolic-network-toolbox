function formula = rp_get_formula(r_name,mn,sub,pro,act,inh,m_sub,m_pro)           

% formula = rp_get_formula(r_name,mn,sub,pro,act,inh,m_sub,m_pro)           
%
...
formula = [ 'u_', r_name ,' * ', activation, inhibition, '( ', ...
            ...
            ' - ', ['kC_' r_name ' / sqrt( kEQ_' r_name ' ' kCratio ' )'] ,numerator_bw, ' )'];
