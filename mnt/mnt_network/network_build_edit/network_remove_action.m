% [network1,keep,keep_actions] = network_remove_action(network,ind)
%
% remove reactions (and metabolites that become obsolete)
%
% ind indices of actions to be removed

function [network1,keep,keep_actions] = network_remove_action(network,ind)
